...
;
; Al igual que los edificios y unidades las investigaciones requieren de varios recursos.
...
(define (problem problema)
  ...
  (:init
    ...
    (esTipoEdificio centro CentroDeMando) (esTipoEdificio barracon Barracones) (esTipoEdificio bahia BahiaDeIngenieria)
