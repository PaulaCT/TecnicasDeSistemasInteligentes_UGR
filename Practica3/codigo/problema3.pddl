...
;
; Modificar las restricciones de construcción nuevos Centros
; de Mando para que requieran tanto Gas como Minerales. El objetivo de este ejercicio es la
; construcción de un edificio de Barracones en una localización.
;
...
(define (problem problema)
  ...
  (:init
    ...
    ; asignación tipos
    (esTipoUnidad u1 VCE) (esTipoUnidad u2 VCE) (esTipoUnidad u3 VCE) (esTipoUnidad u4 VCE) (esTipoEdificio centro CentroDeMando) (esTipoEdificio barracon Barracones)
    (esTipoEdificio extractor Extractor) (esTipoRecurso min1 Minerales) (esTipoRecurso min2 Minerales) (esTipoRecurso min3 Minerales) (esTipoRecurso gas1 Gas) (esTipoRecurso gas2 Gas)
