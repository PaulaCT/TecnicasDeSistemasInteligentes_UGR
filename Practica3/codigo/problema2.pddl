...
;
; El edificio Extractor solo puede construirse en una localización que tenga un nodo de gas y
; necesitará minerales. El objetivo de este ejercicio es la construcción de un edificio de
; Barracones en una localización.
;
...
(define (problem problema)
  ...
  (:init
    ...
    ; asignación tipos
    (esTipoUnidad u1 VCE) (esTipoUnidad u2 VCE) (esTipoUnidad u3 VCE) (esTipoEdificio centro CentroDeMando) (esTipoEdificio barracon Barracones) (esTipoEdificio extractor Extractor)
    ...
    ; recursos
    (necesitaRecurso Barracones Minerales) (necesitaRecurso CentroDeMando Gas) (necesitaRecurso Extractor Minerales)
